...
ETickableTickType UENet6NetworkSubsystem::GetTickableTickType() const
{
	return ETickableTickType::Always;
}

bool UENet6NetworkSubsystem::IsAllowedToTick() const
{
	return true;
}

void UENet6NetworkSubsystem::Tick(float /*DeltaTime*/)
{
	if (!Host)
	{
		return;
...
TStatId UENet6NetworkSubsystem::GetStatId() const
{
	return TStatId();
}

bool UENet6NetworkSubsystem::Connect(FString AddressString)
{
...
void UENet6NetworkSubsystem::Disconnect()
{
	if (ServerPeer)
	{
		check(Host);
...
void UENet6NetworkSubsystem::Initialize(FSubsystemCollectionBase& Collection)
{
...
void UENet6NetworkSubsystem::Deinitialize()
{
	enet_deinitialize();
}
